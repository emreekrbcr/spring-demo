...
public class ProductManager implements ProductService {
	...
	public DataResult<List<Product>> getAll() {
		...
		return new SuccessDataResult<>(products, Messages.SystemMessages.OperationSucceeded);
	}
	...
	public DataResult<Product> getByProductName(String productName) {
		...
		return new SuccessDataResult<>(product, Messages.SystemMessages.OperationSucceeded);
	}
	...
	public DataResult<List<ProductWithCategoryDto>> getProductWithCategoryDetails() {
		...
		return new SuccessDataResult<>(productWithCategoryDtos, Messages.SystemMessages.OperationSucceeded);
	}
}
